              ...
              <div class="col-lg-8">
                <div class="row">
                  <div class="col-sm-4 grid-margin">
                    <div class="rotate-img">
                      <img
                        src="../site/assets/images/politics/Politics_7.jpg"
                        alt="banner"
                        class="img-fluid"
                      />
                    </div>
                ...
                <div class="row">
                  <div class="col-sm-4 grid-margin">
                    <div class="rotate-img">
                      <img
                        src="../site/assets/images/politics/Politics_8.jpg"
                        alt="banner"
                        class="img-fluid"
                      />
                    </div>
                ...
                <div class="row">
                  <div class="col-sm-4 grid-margin">
                    <div class="rotate-img">
                      <img
                        src="../site/assets/images/politics/Politics_11.jpg"
                        alt="banner"
                        class="img-fluid"
                      />
                    </div>
                ...
                <div class="row">
                  <div class="col-sm-4 grid-margin">
                    <div class="rotate-img">
                      <img
                        src="../site/assets/images/politics/Politics_10.jpg"
                        alt="banner"
                        class="img-fluid"
                      />
                    </div>
                    ...
                    <div class="border-bottom pb-4 pt-4">
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <div class="rotate-img">
                            <img
                              src="../site/assets/images/politics/Politics_1.jpg"
                              alt="banner"
                              class="img-fluid"
                            />
                          </div>
                    ...
                    <div class="border-bottom pb-4 pt-4">
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <div class="rotate-img">
                            <img
                              src="../site/assets/images/politics/Politics_2.jpg"
                              alt="banner"
                              class="img-fluid"
                            />
                          </div>
                    ...
                    <div class="pt-4">
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <div class="rotate-img">
                            <img
                              src="../site/assets/images/politics/Politics_3.jpg"
                              alt="banner"
                              class="img-fluid"
                            />
                          </div>
